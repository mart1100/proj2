...
class Ui_wtyczkaDialogBase(object):
    def setupUi(self, wtyczkaDialogBase):
        ...
        self.plik.setGeometry(QtCore.QRect(130, 300, 151, 27))
        self.plik.setObjectName("plik")
        self.tableWidget_wsp = QtWidgets.QTableWidget(wtyczkaDialogBase)
        self.tableWidget_wsp.setGeometry(QtCore.QRect(70, 170, 256, 121))
        ...
        self.comboBox_jed.setGeometry(QtCore.QRect(350, 430, 73, 22))
        self.comboBox_jed.setObjectName("comboBox_jed")
        self.pushButton_wyczysc = QtWidgets.QPushButton(wtyczkaDialogBase)
        self.pushButton_wyczysc.setGeometry(QtCore.QRect(60, 530, 93, 28))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
